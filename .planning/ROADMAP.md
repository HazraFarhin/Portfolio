...
- [x] **Phase 3: Homepage Build** - Single-scroll homepage assembling hero through footer from real content and motion hooks (completed 2026-07-31)
...
- [x] 03-06-PLAN.md — Contact/Brief form UI + Footer (HOME-08, CONT-04)
- [x] 03-07-PLAN.md — Home route integration capstone (mounts all sections, repoints Hero CTA)
...
- [x] 03-06-PLAN.md — Contact/Brief + Footer

**Wave 3** *(blocked on Wave 1 + 03-06 completion)*

- [x] 03-07-PLAN.md — Home route integration (capstone)
...
- [x] 04-01-PLAN.md — Package legitimacy checkpoint + install resend
- [x] 04-03-PLAN.md — Footer.tsx submission handler + honeypot + success/error states
- [x] 04-04-PLAN.md — Selected Work simplification + REQUIREMENTS.md update
- [x] 04-05-PLAN.md — robots.txt + sitemap.xml
